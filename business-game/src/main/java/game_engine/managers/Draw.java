...
public class Draw {
    ...
    public static void polygon(List<Vector2> points, double x, double y, double angle, double scale) {
        ...
        canvas.strokePolygon(pointsX, pointsY, points.size());
        Draw.canvas.restore();
    }
    ...
    public static void circle(double x, double y, double radius) {
        ...
        canvas.strokeOval(0, 0, radius, radius);
        Draw.canvas.restore();
    }
    ...
    public static void tilemap(Tile[][] tilemap, Vector2 position, Vector2Int size, double scale, double angle) {
        scale *= pixel_size;
